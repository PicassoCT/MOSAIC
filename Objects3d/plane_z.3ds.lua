model = {
	...
	tex1 = "rocks_color_bc3_unorm.dds",
	...
	pbr = {
		...
		occlusionMap = {
			...
			--get = "[3].r",
			gammaCorrection = false, -- do sRGB to RGB in-shader translation. Defaults to false, as ao should be saved linearly.
		},
		roughnessMap = {
			scale = 1.0, --acts as a multiplier or a base value (if get is nil)
			--get = "[3].g",
			gammaCorrection = false, -- do sRGB to RGB in-shader translation. Defaults to false, as roughness should be saved linearly.
		},
		metallicMap = {
			scale = 0.0, --acts as a multiplier or a base value (if get is nil)
			--get = "[3].b",
			gammaCorrection = false, -- do sRGB to RGB in-shader translation. Defaults to false, as metalness should be saved linearly.
		},
		iblMap = {
