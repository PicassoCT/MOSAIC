...
if LUA_NAME == "LuaUI" then
	...
	ORDER_FILENAME  = LUAUI_DIRNAME .. 'configs/' .. Game.modShortName .. '_order.lua'
	CONFIG_FILENAME = LUAUI_DIRNAME .. 'configs/' .. Game.modShortName .. '_data.lua'
	KNOWN_FILENAME  = LUAUI_DIRNAME .. 'configs/' .. Game.modShortName .. '_known.lua'
	...
	Spring.CreateDir(LUAUI_DIRNAME .. 'configs')
