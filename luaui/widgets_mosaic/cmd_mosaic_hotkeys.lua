function widget:GetInfo()
	return {
		name = "MOSAIC Hotkeys",
		desc = "Enables MOSAIC Hotkeys, including ZXCV,BN,YJ,O,Q" ,
		author = "Beherith",
		date = "23 march 2012",
...
function widget:Initialize()
    ...
    WG.Reload_MOSAIC_Hotkeys = ReloadBindings
end

function widget:Shutdown()
    UnloadBindings()
    WG.Reload_MOSAIC_Hotkeys = nil

    if widgetHandler.orderList and (widgetHandler.orderList["MOSAIC Hotkeys -- swap YZ"] or 0) > 0 then
        widgetHandler:DisableWidget("MOSAIC Hotkeys -- swap YZ")
    end
end
