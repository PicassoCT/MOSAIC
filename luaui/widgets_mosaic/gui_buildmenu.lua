...
local antagonToProtagon = {
	--Shared
	[UnitDefNames["propagandaserver"].id] = UnitDefNames["propagandaserver"].id,
	...
	[UnitDefNames["air_copter_aerosol_tollwutox"].id] = UnitDefNames["air_copter_aerosol_tollwutox"].id,
	[UnitDefNames["air_copter_aerosol_depressol"].id] = UnitDefNames["air_copter_aerosol_depressol"].id,
	[UnitDefNames["ground_turret_cm_antiarmor"].id] = UnitDefNames["ground_turret_cm_antiarmor"].id,
	[UnitDefNames["ground_turret_cm_airstrike"].id] = UnitDefNames["ground_turret_cm_airstrike"].id,
	[UnitDefNames["ground_turret_cm_transport"].id] = UnitDefNames["ground_turret_cm_transport"].id,
	[UnitDefNames["ground_turret_mg"].id] = UnitDefNames["ground_turret_mg"].id,
	[UnitDefNames["ground_turret_antiarmor"].id] = UnitDefNames["ground_turret_antiarmor"].id,
	[UnitDefNames["ground_turret_rocket"].id] = UnitDefNames["ground_turret_rocket"].id,
	...
	[UnitDefNames["civilian_truck_ssied"].id] = UnitDefNames["civilian_truck_ssied"].id,
	[UnitDefNames["ground_truck_antiarmor"].id] = UnitDefNames["ground_truck_antiarmor"].id,
	[UnitDefNames["ground_truck_rocket"].id] = UnitDefNames["ground_truck_rocket"].id,
	[UnitDefNames["ground_truck_assembly"].id] = UnitDefNames["ground_truck_assembly"].id,
	...
	[UnitDefNames["protagonassembly"].id] = UnitDefNames["protagonassembly"].id,
	[UnitDefNames["antagonassembly"].id] = UnitDefNames["antagonassembly"].id,
	[UnitDefNames["checkpoint"].id] = UnitDefNames["checkpoint"].id,
	[UnitDefNames["civilianagent"].id] = UnitDefNames["civilianagent"].id,
	[UnitDefNames["operativeasset"].id] = UnitDefNames["operativeasset"].id,

	--Different
	[UnitDefNames["antagonsafehouse"].id] = UnitDefNames["protagonsafehouse"].id,
	[UnitDefNames["hivemind"].id] = UnitDefNames["aicore"].id,
	[UnitDefNames["launcher"].id] = UnitDefNames["blacksite"].id,

	[UnitDefNames["operativepropagator"].id] = UnitDefNames["operativeinvestigator"].id,

}
local protagonToAntagon = table_invert(antagonToProtagon)
		...
		if preGamestartPlayer then
			...
			for b = 1, #buildQueue do
				...
				if startDefID == UnitDefNames["armcom"].id then
					if protagonToAntagon[buildDataId] ~= nil then
						buildData[1] = protagonToAntagon[buildDataId]
						buildQueue[b] = buildData
					end
				elseif startDefID == UnitDefNames["corcom"].id then
					if antagonToProtagon[buildDataId] ~= nil then
						buildData[1] = antagonToProtagon[buildDataId]
						buildQueue[b] = buildData
					end
				end
			end
