...
local antagonToProtagon = {
	...
	[UnitDefNames["ground_turret_cm_airdrop"].id] = UnitDefNames["ground_turret_cm_airdrop"].id,
	[UnitDefNames["ground_turret_cm_walker"].id] = UnitDefNames["ground_turret_cm_walker"].id,
	[UnitDefNames["ground_turret_cm_antiarmor"].id] = UnitDefNames["ground_turret_cm_antiarmor"].id,
	[UnitDefNames["ground_turret_cm_ssied"].id] = UnitDefNames["ground_turret_cm_ssied"].id,
	...
	[UnitDefNames["ground_tank_night"].id] = UnitDefNames["ground_tank_day"].id,
