...
local function init()
    ...
    fragmentShader = fragmentShader:gsub("// RAIN_SPLASHBACK", function()
        return VFS.LoadFile(shaderFilePath .. "rainSplashback.glsl")
    end, 1)
