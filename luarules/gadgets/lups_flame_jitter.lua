...
if (gadgetHandler:IsSyncedCode()) then
    ...
    function FlameShot(unitID, unitDefID, _, weapon)
        ...
        if (((lastLupsSpawn[unitID][weapon] or 0) - thisGameFrame) <=
            -MIN_EFFECT_INTERVAL) then
    ...
    lastShoot[unitID][weapon] = n
        ...
        local posx, posy, posz, dirx, diry, dirz =
            Spring.GetUnitWeaponVectors(unitID, weapon)
        ...
        local partpos = "x*delay,y*delay,z*delay|x=" .. speedx .. ",y=" ..
                            speedy .. ",z=" .. speedz
        ...
        particleList[particleCnt] = {
            ...
            colormap = {
                {1, 1, 1, 0.01}, {1, 1, 1, 0.01}, {0.75, 0.5, 0.5, 0.01},
                {0, 0, 0, 0.01}
            },
            count = 1,
            ...
            texture = altFlameTexture and "bitmaps/GPL/flame_alt.png" or
                "bitmaps/GPL/flame.png"
        }
        particleCnt = particleCnt + 1
