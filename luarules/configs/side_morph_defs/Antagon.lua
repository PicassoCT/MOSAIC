local antagonDefs = {
   	antagonsafehouse = {
		...
		},		
		{
			...
			energy = 5000,
			time = 60,
			name = 'Become Automatic Autonomous Assembly',
		...
		},	
		{
			...
			energy = 2500,
			time = 7*60,
			name = 'Become Hivemind Supra Intelligence',
