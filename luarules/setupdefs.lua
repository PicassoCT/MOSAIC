...
do
    local tbl = {}
    for _, def in pairs(UnitDefs) do tbl[def.name] = def end
    UnitDefNames = tbl
end
...
do
    local tbl = {}
    for _, def in pairs(FeatureDefs) do tbl[def.name] = def end
    FeatureDefNames = tbl
end
...
do
    local tbl = {}
    for _, def in pairs(WeaponDefs) do tbl[def.name] = def end
    WeaponDefNames = tbl
end
