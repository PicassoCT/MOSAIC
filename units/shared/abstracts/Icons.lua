...
local BribeIcon =
    ...
    buildTime = 1, -- Money buys a quick deployment; operative build power is 0.5-1.
    iconType = "BribeIcon",
    explodeAs = "none",
    Acceleration = 0.1,
    BrakeRate = 1.0,
    ...
    upright  = true,
    --
    description = "Guard an operative to deter police; Move to divert patrols. 60 seconds, up to 3 officers. No military effect.",
    levelGround = false,
    CanAttack = false,
    CanGuard = true,
    name = "Policebribe",
    ...
    customparams = {
        helptext = "Police influence: Guard a friendly operative or Move to a false dispatch. Witnessed violence breaks protection.",
        baseclass = "Abstract" -- TODO: hacks
    },
    category = "NOTARGET ABSTRACT"
}
...
local CyberCrime =
    ...
    --
    description = "Extract from a nearby city building for 120 seconds. Own safehouses improve income; police can shut it down.",
    levelGround = false,
    CanAttack = false,
    CanGuard = false,
    name = "Botnet Node",
    ...
    activatewhenbuilt = true,
    MaxSlope = 100,
    buildTime = 30, -- 30 seconds of an investigator/propagator's construction time.

    customparams = {
        helptext = "Free to start. One extraction per building. Once per match, a team unable to afford a propaganda server and owning none gets 1000 money and energy.",
        baseclass = "Abstract" -- TODO: hacks
    },
    category = "NOTARGET ABSTRACT"
}
