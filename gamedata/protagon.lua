local protagonUnits = {
  ...
  protagonassembly =
  {
	"ground_turret_ssied",				   "ground_turret_mg",	                  "ground_turret_rocket",
  "ground_turret_antiarmor",       "ground_turret_hedgehog",              "ground_turret_dronegrenade" ,
	"ground_turret_cm_airstrike",		 "ground_turret_cm_antiarmor", 					"ground_turret_cm_transport", 
	"ground_turret_cm_airtransport", "ground_tank_day"                      "truck_arab6" ,
	"ground_walker_mg",					     "ground_walker_grenade", 					    "ground_truck_assembly", 
