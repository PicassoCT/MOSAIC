...
function backflip(speed)
	moveFactor= 14
	tP(deathpivot, 0,0,0,0)
	mP(deathpivot, 0,0,0,0)
	divisor= 0.4
	--sword pierce up
		     
			mP(tigLil,0,-7,6,8*speed*moveFactor)
			tSyncIn(tigLil,27,0,0,225)
				tSyncIn(tlHead,0,0,0,225*divisor)
				tSyncIn(tlhairup,-41,0,0,225*divisor)
				tSyncIn(tlhairdown,33,0,0,225*divisor)
				tSyncIn(tllegUp,-118,0,0,225*divisor)
				tSyncIn(tllegLow,87,0,0,225*divisor)
				tSyncIn(tllegUpR,34,0,0,225*divisor)
				tSyncIn(tllegLowR,0,0,0,225*divisor)
				tSyncIn(tlarm,0,94,-39,225*divisor)
				tSyncIn(tlarmr,0,-102,41,225*divisor)
	...
	--knee down
			...
			mP(tigLil,0,-8,5,8*speed*moveFactor)
			tSyncIn(tigLil,0,0,0,175*divisor)
				tSyncIn(tllegUp,-93,0,0,175*divisor)
				tSyncIn(tllegLow,105,0,0,175*divisor)
				tSyncIn(tllegUpR,-62,0,0,175*divisor)
				tSyncIn(tllegLowR,148,0,0,175*divisor)
				tSyncIn(tlarm,0,0,-52,175*divisor)
				tSyncIn(tlarmr,0,0,51,175*divisor)
				tSyncIn(tlHead,25,0,0,175*divisor)
				tSyncIn(tlhairup,-104,0,0,175*divisor)
				tSyncIn(tlhairdown,0,0,0,175*divisor)
				WaitForTurns(deathpivot,tigLil,tllegUp,tllegLow,tllegUpR,tllegLow,tlarm,tlarmr,tlHead,tlhairup,tlhairdown)
				WaitForMoves(tigLil)
	-- jump up	       
			mP(tigLil,0,-2,5,6*speed*moveFactor)
			tSyncIn(tigLil,-56,0,0,150*divisor)
				tSyncIn(tllegUp,9,0,0,150*divisor)
				tSyncIn(tllegLow,28,0,0,150*divisor)
				tSyncIn(tllegUpR,2,0,0,150*divisor)
				tSyncIn(tllegLowR,55,0,0,150*divisor)
				tSyncIn(tlarm,-164,0,55,150*divisor)
				tSyncIn(tlarmr,-164,0,-51,150*divisor)
				tSyncIn(tlHead,-34,0,0,150*divisor)
				tSyncIn(tlhairup,2,0,0,150*divisor)
				tSyncIn(tlhairdown,-10,0,0,150*divisor)
				WaitForTurns(deathpivot,tigLil,tllegUp,tllegLow,tllegUpR,tllegLow,tlarm,tlarmr,tlHead,tlhairup,tlhairdown)
				WaitForMoves(tigLil)
	-- backflip
				mP(tigLil,0,-1,1,5*speed*moveFactor)
				tSyncIn(tigLil,-152,0,0,250*divisor)
				tSyncIn(tllegUp,69,0,0,250*divisor)
				tSyncIn(tllegLow,28,0,0,250*divisor)
				tSyncIn(tllegUpR,85,0,0,250*divisor)
				tSyncIn(tllegLowR,55,0,0,250*divisor)
				tSyncIn(tlarm,-232,0,55,250*divisor)
				tSyncIn(tlarmr,-232,0,-51,250*divisor)
				tSyncIn(tlHead,-34,0,0,250*divisor)
				tSyncIn(tlhairup,-26,0,0,250*divisor)
				tSyncIn(tlhairdown,27,0,0,250*divisor)
				WaitForTurns(deathpivot,tigLil,tllegUp,tllegLow,tllegUpR,tllegLow,tlarm,tlarmr,tlHead,tlhairup,tlhairdown)
				WaitForMoves(tigLil)
	--landing
				mP(tigLil,0,-5,0,5*speed*moveFactor)
				tSyncIn(tigLil,-307,0,0,200*divisor)
				tSyncIn(tllegUp,-106,0,0,200*divisor)
				tSyncIn(tllegLow,114,0,0,200*divisor)
				tSyncIn(tllegUpR,-20,60,0,200*divisor)
				tSyncIn(tllegLowR,63,0,0,200*divisor)
				tSyncIn(tlarm,-53,0,55,200*divisor)
				tSyncIn(tlarmr,-53,0,-51,200*divisor)
				tSyncIn(tlHead,8,0,0,200*divisor)
				tSyncIn(tlhairup,60,0,0,200*divisor)
				tSyncIn(tlhairdown,22,0,0,200*divisor)
				WaitForTurns(deathpivot,tigLil,tllegUp,tllegLow,tllegUpR,tllegLow,tlarm,tlarmr,tlHead,tlhairup,tlhairdown)
				WaitForMoves(tigLil)
	--rest
				mP(tigLil,0,-10,0,5*speed*moveFactor)
				tSyncIn(tigLil,-307,0,0,75*divisor)
				tSyncIn(tllegUp,-140,0,0,75*divisor)
				tSyncIn(tllegLow,143,0,0,75*divisor)
				tSyncIn(tllegUpR,-108,61,13,75*divisor)
				tSyncIn(tllegLowR,63,0,0,75*divisor)
				tSyncIn(tlarm,-53,0,29,75*divisor)
				tSyncIn(tlarmr,-56,0,-24,75*divisor)
				tSyncIn(tlHead,80,0,0,75*divisor)
				tSyncIn(tlhairup,104,0,0,75*divisor)
				tSyncIn(tlhairdown,61,0,0,75*divisor)
				WaitForTurns(deathpivot,tigLil,tllegUp,tllegLow,tllegUpR,tllegLow,tlarm,tlarmr,tlHead,tlhairup,tlhairdown)
				WaitForMoves(tigLil)
				Sleep(1200)
				mP(tigLil,0,0,0,5*speed*moveFactor)
				tP(tigLil,0,0,0,5*speed*moveFactor)
end
