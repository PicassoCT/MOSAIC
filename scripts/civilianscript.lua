...
function testAnimationLoop()
	...
	while true do
		...
		PlayAnimation("UPBODY_CONSUMPTION", {})
...
["UPBODY_CONSUMPTION"]={
{
		...
		['commands'] = {
			...
			{['c']='turn',['p']=UpArm1, ['a']=z_axis, ['t']=-0.000000, ['s']=1.448925},

			{['c']='turn',['p']=LowArm1, ['a']=x_axis, ['t']=-1.692945+math.pi/2, ['s']=1.139575},
			{['c']='turn',['p']=LowArm1, ['a']=y_axis, ['t']=-0.346358, ['s']=1.353786},
			{['c']='turn',['p']=LowArm1, ['a']=z_axis, ['t']=1.296930, ['s']=1.884950},
			...
			{['c']='turn',['p']=LowArm2, ['a']=y_axis, ['t']=0.033651, ['s']=0.267672},
	...
	},
	{
		['time'] = 12,
		['commands'] = {
			{['c']='turn',['p']=LowArm1, ['a']=x_axis, ['t']=-1.650712 +math.pi/2, ['s']=0.097461},
