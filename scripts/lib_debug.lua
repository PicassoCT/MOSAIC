...
function assertPieceDictValue(unitID, T, name)
    ...
    function checkGlobalTable(frame)
        ...
        nrElments = recursiveCheckTable(GG, 8192, false)--frame % 1000 == 0)
        echo("GG contains "..nrElments.." elements")
         sizeInByte= getSizeInByte(GG, 12)
       ...
       echo("")
        ...
        function checkTable(frame, Table)
        if frame % 100 == 0 then
        echo("")
        echo("==================GlobalGameTable Data==================")
        nrElments = recursiveCheckTable(Table, 8192, false)--frame % 1000 == 0)
        echo("Table contains "..nrElments.." elements")
         sizeInByte= getSizeInByte(Table, 12)
           echo("Table is of size ".. sizeInByte.." bytes")
            echo("==========================================================")
       echo("")
       end      
    end