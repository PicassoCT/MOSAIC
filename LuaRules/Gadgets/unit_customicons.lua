...
for i=0,3 do
icons[#icons+1] = {"civilian_arab"..i, "civilian", 0.5}
end

for i=0,8 do
icons[#icons+1] = {"truck_arab"..i, "truck", 0.5}
end
        ...
        if iconname then
            ...
            for i, icon in ipairs(icons) do
                if string.gsub(icon[1], '.user', '') == iconname then
                    ...
                    addUnitIcon(icon[1], 'icons/'..iconname..'.png', tonumber(scalenum)*iconScale)
                    loadedIcons[#loadedIcons+1] = icon[1]
                end
            end
        end
        ...
        if name then
            ...
            if unitname and UnitDefNames[unitname] then
                ...
                if scale ~= '' and UnitDefNames[unitname] then
                    ...
                    Spring.SetUnitDefIcon(UnitDefNames[unitname].id, scavPrefix..unitname..".user")
